...
export default function Trainings(): ReactElement  {
  return (
    <div className='relative sm:ml-60 px-6 sm:px-20 mt-20'>
      <div className='scrollbar overflow-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-h-80hv'>
        <ol className="relative border-l border-gray-200 dark:border-gray-700">
          ...
          <a href="/">
            <li className="mb-10 ml-6">
              ...
              <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Fly-йога</h3>
              <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Вівторок 24 червня 2023р.</time>
              <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Тренування відбувається на підвісних гамаках, обручах, ременях, тканинах. Поєднує пілатес, йогу та гімнастику. </p>
            </li>
          </a>
          <a href="/">
            <li className="mb-10 ml-6">
              ...
              <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Тай-бо</h3>
              <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Понеділок 23 червня 2023р.</time>
              <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">це техніка бойових мистецтв. Включає в себе аеробні навантаження, розвиток ударів руками та ногами.</p>
            </li>
          </a>
        </ol>
      </div>
